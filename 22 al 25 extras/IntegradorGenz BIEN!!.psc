Algoritmo IntegradorGenz
	...
	palabra="adcdccbda"
	//	Hacer //ingreso de la palabra y validacion del tamaño
	//		Hacer
	//			Escribir "Ingrese la palabra que desea evaluar (debe contener 9,16 o 1369 caracteres y ser A, B, C o D)"
	//			leer palabra
	//			palabra = Mayusculas(palabra)
	//			para i = 0 hasta Longitud(palabra)-1 //validación si no es A,B,C o D
	...
	//	Mientras Que Longitud(palabra) <> 9 y Longitud(palabra) <> 16 y Longitud(palabra) <> 1369 //revisa tamaño de la matriz

...
SubProceso imprimirMatriz (matriz, vector)
	Definir i, j Como Entero
	definir matrizvis Como Caracter
	dimension matrizvis[7,7]
	Para i <- 0 Hasta 5 Hacer
		Para j <- 0 Hasta 5 Hacer
	...
	para i<-0 hasta 6 Hacer
		para j<-0 hasta 6 Hacer
			si i=0 o j=0 Entonces
				matrizvis[i,j]=""
			FinSi
			si i=0 o j=1 Entonces
				matrizvis[i,j]="lunes"
			FinSi
			si i=0 o j=2 Entonces
				matrizvis[i,j]="martes"
			FinSi
			si i=0 o j=3 Entonces
				matrizvis[i,j]="miercoles"
			FinSi
			si i=0 o j=4 Entonces
				matrizvis[i,j]="jueves"
			FinSi
			si i=0 o j=5 Entonces
				matrizvis[i,j]="vienes"
			FinSi
			si i=0 o j=6 Entonces
				matrizvis[i,j]="producto total"
			FinSi
			si i=1 o j=0 Entonces
				matrizvis[i,j]="producto1"
			SiNo
				matriz vis[i,j]=
			FinSi
			matrizvis[i,j]= ConvertirATexto(matriz[i,j])
		FinPara
	FinPara
FinSubProceso
